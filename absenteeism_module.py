...
# create the special class that we are going to use from here to predict the new data
class absenteeism_model():
        ...
        def load_and_clean_data(self, data_file):
            ...
            # to preserve the code we've created in the previous sectoin, we will add a column with 'Nan' strings
            ...
            # to avoid multicolinearity, drop the 'Reason for Absence' column off
            df = df.drop(['Reason for Absence'], axis=1)
            
            # concatenate df and the 4 types of reason for absence
            df = pd.concat([df, reason_type_1, reason_type_2, reason_type_3,reason_type_4], axis=1)
            
            # asign names to the 4 reason tpye columns
            ...
            # insert the values into a new column in dfm called 'Month Value'
            ...
            # drop the variables that we decided we don't need
